...
### Sample invocation: ./NnUnetTrain_agate.sh 0 faird [-c]

#SBATCH --job-name=902_$1_Train_nnUNet # job name
...
#SBATCH --mail-user=cart0660@umn.edu
#SBATCH -e Train_$1_902_nnUNet-%j.err
#SBATCH -o Train_$1_902_nnUNet-%j.out
...
export nnUNet_raw_data_base="/scratch.global/lundq163/nnUNet_t1_t2_test/nnUNet_raw_data_base_test_ermias/"
export nnUNet_preprocessed="/scratch.global/lundq163/nnUNet_t1_t2_test/nnUNet_raw_data_base_test_ermias/nnUNet_preprocessed/"
export RESULTS_FOLDER="/home/faird/shared/data/nnUNet_lundq163/nnUNet_raw_data_base/nnUNet_trained_models/"

nnUNet_train 3d_fullres nnUNetTrainerV2_noMirroring 902 $1 $3
EOT
